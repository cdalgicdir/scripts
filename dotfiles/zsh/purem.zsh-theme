...
zstyle ':vcs_info:*:*' formats "\e[38;5;172m%~\e[00m %F{blue}$FX[bold]%r$FX[no-bold]/%S" "%s/%b" "%%u%c"
zstyle ':vcs_info:*:*' actionformats "$FX[bold]%r$FX[no-bold]/%S" "%s/%b" "%u%c (%a)"
zstyle ':vcs_info:*:*' nvcsformats "\e[38;5;172m%~\e[00m" "" ""
...
repo_information() {
    ...
    echo "${vcs_info_msg_0_%%/.} \e[38;5;245m$vcs_info_msg_1_`git_dirty` $vcs_info_msg_2_%f\e[00m"
}
